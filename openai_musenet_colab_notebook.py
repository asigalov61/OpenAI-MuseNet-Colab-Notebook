...
number_of_tokens_to_generate = 256 #@param {type:"slider", min:64, max:1024, step:8}
...
which_completion = -1 #@param {type:"slider", min:-1, max:3, step:1}
...
INSTRUMENTS = ["piano", "piano", "piano", "piano", "piano", "piano", "piano", "piano", "piano",
               ...
               "flute", "flute", "clarinet", "clarinet", "harp", "harp", "trumpet", "trumpet",
               "drum", "drum"]
...
FNAME = '/content/MuseNet-Companion'
...
for token in encoding:
    if 0 <= int(token) < 3840:
        ...
        delta_times[channel] = (int(token) % 128) + 1
...
#@title [DEV] Load Custom MIDI

# Prep for continuations

data = TMIDIX.Optimus_MIDI_TXT_Processor('/content/tegridy-tools/tegridy-tools/seed2.mid', MIDI_patch=range(127))
